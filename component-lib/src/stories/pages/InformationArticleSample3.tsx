...
import { Header, SvgIcon } from '../../index';
    ...
    <div className="container container--medium container--no-padding container--extra-margin-bottom container--white-bg container--extra-padding-top container--overlapping-full-width-image">
      <div className="rich-text container container--small">
        <p className="paragraph">
          Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Proin eget tortor risus. Cras ultricies
          ligula sed magna dictum porta. Sed porttitor lectus nibh. Sed porttitor lectus nibh.
        </p>
      </div>
      <div className="rich-text container container--small">
        <ul className="step-by-step">
          <li className="step-by-step__step-wrapper">
            <div className="step-by-step__step step-by-step__circle">
              <SvgIcon className="step-by-step__icon" iconName="ico_buy" />
            </div>
            ...
            <div className="step-by-step__content">
              ...
              suscipit, diam sem vulputate ex, posuere cursus mi arcu ac nunc. Vestibulum dictum metus nisi, non mattis
              diam porttitor ut. Nullam suscipit risus eget lacus gravida sagittis. Suspendisse massa augue, mollis a
              pretium nec, faucibus nec lorem. In hac habitasse platea dictumst. Integer rhoncus, massa at pretium
              molestie, dolor felis vulputate turpis, sit amet malesuada nulla odio quis neque. Praesent vel dolor
              tempor, posuere dolor ultrices, malesuada leo. Suspendisse et efficitur mi. Fusce nunc arcu, lacinia quis
              risus ut, sollicitudin rutrum ante. Nam arcu augue, feugiat eu lectus eu, bibendum cursus turpis. Duis
              feugiat sem a scelerisque tincidunt.
            </div>
          </li>
          <li className="step-by-step__step-wrapper">
            <div className="step-by-step__step step-by-step__circle step-by-step__step--no-border">
              <img className="step-by-step__image" src={img.boyIpad} alt="" />
            </div>
            <div className="step-by-step__text">
          ...
          <li className="step-by-step__step-wrapper">
            ...
            <div className="step-by-step__text">
              ...
              <div className="step-by-step__description">
                ...
                enim. Vivamus suscipit tortor eget felis porttitor volutpat. Vestibulum ante ipsum primis in faucibus
                ...
                imperdiet et, porttitor at sem. Curabitur aliquet quam id dui posuere blandit. Praesent sapien massa,

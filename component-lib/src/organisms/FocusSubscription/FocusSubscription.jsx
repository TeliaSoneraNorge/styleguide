                        ...
                        <div className="focus-subscription__main-content">
                            ...
                            <ul className="list list--links">
                                <li className="list__item">
                                    <a className="list__link" href="#" target="_self">SIM, PIN og PUK</a>
                                </li>
                                <li className="list__item">
                                    <a className="list__link" href="#" target="_self">Sperringer</a>
                                </li>
                                <li className="list__item">
                                    <a className="list__link" href="#" target="_self">Sjekk ditt forbruk</a>
                                </li>
                                <li className="list__item">
                                    <a className="list__link" href="#" target="_self">Dine fakturaer</a>
                                </li>
                            </ul>
                        </div>
                    </div>

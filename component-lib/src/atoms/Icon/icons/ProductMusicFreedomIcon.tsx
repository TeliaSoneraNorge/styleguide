...
//
// Generated from: product-music-freedom.svg
//
...
export function ProductMusicFreedomIcon(props: Props) {
  return (
    <svg
      className={cs('Icon', 'Icon--product-music-freedom', props.className)}
      style={props.style}

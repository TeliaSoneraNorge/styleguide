...
export const InlineRightQuote = () => (
  ...
  <section className="container container--small">
    <p>
      ...
      Curabitur aliquet quam id dui posuere blandit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
    ...
    <p>
      ...
      Curabitur aliquet quam id dui posuere blandit. Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium

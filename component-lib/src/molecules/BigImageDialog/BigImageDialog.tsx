...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'src' does not exist on type 'Props'.
const BigImageDialog = ({ name, heading, description, src, children, onClose, standalone, renderTo, ...rest }: Props) => {

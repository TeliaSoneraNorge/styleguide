...
export const TabList = ({ children, selectedIndex, uniqueId, onSelect }) => (
...
export const Tab = ({ index, uniqueId, selectedIndex, heading, onSelect }) => (
  <li
...
export const TabPanels = ({ children, uniqueId, selectedIndex }) =>
  children.map((element, index) =>

...
const getThresholdFromValue = (thresholds, value) =>
  thresholds.sort((a, b) => b.to - a.to).reduce((prev, curr) => (curr.to >= value ? curr : prev), null);
 ...
 *
 */
const ProgressChart = ({ value, percent, loading, thresholds, valueCaption, loadingCaption }) => (

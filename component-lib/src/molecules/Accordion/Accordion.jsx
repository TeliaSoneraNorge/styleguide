...
const Accordion = ({
    ...
    return (
        <section
            className={`accordion${isExpanded ? ' accordion--open' : ''}`}
            ref={accordionRef}>
            <h3 className={`accordion__header${button ? ' accordion__header--with-button' : ''} heading heading--level-3`}>
                <button
                    ...
                    {icon && (
                        <SvgIcon className="accordion__icon" iconName={icon} title={iconTitle} />
                    )}
                    {imageUrl && (
                    ...
                    <div className={classnames('accordion__header-button--text-box', { 'accordion__header-button--text-box-no-icon': !icon })}>
                        {title}
                        {text && (
                            <div className="accordion__header-button--text-box-text">{text}</div>
                        )}
                    </div>
                </button>

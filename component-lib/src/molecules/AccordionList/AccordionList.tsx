...
const AccordionList = ({ accordionItems, setItemRef, isExpandedAccordionIndex, toggleIsExpanded, noBorder, className, shouldAnimateHeaderButtonTextBox }: Props) => (
  <div className={cn('accordion-list', { 'accordion-list__no-border': noBorder, [className]: className })}>
    {accordionItems.map((accordionItem, i) => (
      <Accordion
        accordionRef={(element: any) => {

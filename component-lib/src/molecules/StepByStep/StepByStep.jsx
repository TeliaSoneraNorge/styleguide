...
const Step = ({ children, className, index, opened, onSelect, interactive, ...rest }) => (
    <li
...
const Description = ({ children, className, heading, iconName, imageSrc, number, pebbles, onSelect, index, interactive, opened, ...rest }) => (
    <React.Fragment>

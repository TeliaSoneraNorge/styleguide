...
export const Step = ({ children, className, index, opened, onSelect, interactive, ...rest }) => (
  <li
...
export const Description = ({
  ...
  <React.Fragment>
    <Icon pebbles={pebbles} onSelect={onSelect} index={index} interactive={interactive} opened={opened}>
      ...
      {imageSrc && <img alt="" className="step-by-step__icon" src={imageSrc} />}
...
export const Content = ({ children, className, opened, interactive, ...rest }) => (
  <div

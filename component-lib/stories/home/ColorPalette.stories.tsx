     ...
     {colorsJSON.map(color => (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <p style={{ minWidth: style.minWidth }}>
            <span style={{ color: 'rgba(0,0,0,.4)', background: '#f8f8f8', padding: '.2rem', marginRight: '.5rem', fontSize: '12px' }}>HEX</span>
            {color.hex}
          </p>
          <p style={{ minWidth: style.minWidth }}>
            <span style={{ color: 'rgba(0,0,0,.4)', background: '#f8f8f8', padding: '.2rem', marginRight: '.5rem', fontSize: '12px' }}>RGB</span>
            {color.rgb}
          </p>
          {color.alias ? 
            <p style={{ minWidth: style.minWidth }}>
              <span style={{ color: 'rgba(0,0,0,.4)', background: '#f8f8f8', padding: '.2rem', marginRight: '.5rem', fontSize: '12px' }}>ALIAS</span>
              {color.alias}
            </p>
            : null
          }

...
export interface Props {
  ...
  onValidateStep?: any; //When changing step, call on a validator first and it not "input is email", return false on a step, then bypassing it is impossible (even if you click on a step larger, it wont move)?

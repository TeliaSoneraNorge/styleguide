...
export const ToggleOnLeftSide = () => (
  <ToggleButton id="example-4" labelText="This is the label text" toggleOnLeftSide />
);
...
export const WithLongLabelText = () => (
  <ToggleButton id="example-2" labelText="Example with a much longer label text, like really really long, yeah?" />
);

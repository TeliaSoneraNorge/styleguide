...
const imgs = [require('assets/website-images/screenshot1.png'), require('assets/website-images/screenshot2.png')];

const DefaultDisplayFunctionality = () => (
  <DisplayFunctionality reverse={true} imgs={imgs} deviceImageUrl={require('assets/website-images/laptop.png')}>

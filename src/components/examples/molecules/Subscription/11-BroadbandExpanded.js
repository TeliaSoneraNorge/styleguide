...
const BroadbandExpanded = () => (
  ...
  >
    <RadioButtonList type="vertical" hasRichContent>
      <RadioButtonWithLabel hasRichContent value="0" name="radiobutton-broadband">
        ...
        <img
          ...
          src={require('assets/website-images/router1.jpg')}
        />
      ...
      <RadioButtonWithLabel hasRichContent value="1" name="radiobutton-broadband">
        ...
        <img
          style={{ display: 'inline-block', float: 'right', width: '20%' }}
          src={require('assets/website-images/router2.png')}
        />
      </RadioButtonWithLabel>
    ...
    <div className="rich-text">
      ...
      <p>
        I was going to say something extremely rough to Lorem Ipsum, to its family, and I said to myself, "I can't do
        it. I just can't do it. It's inappropriate. It's not nice." When other websites give you text, they’re not
        sending the best. They’re not sending you, they’re sending words that have lots of problems and they’re bringing
        those problems with us. They’re bringing mistakes. They’re bringing misspellings. They’re typists… And some, I
        assume, are good words. I think the only card she has is the Lorem card.
      </p>
      ...
      <p>
        ...
        negative ipsum covfefe. Lorem Ipsum is the single greatest threat. We are not - we are not keeping up with other
        websites.
      </p>

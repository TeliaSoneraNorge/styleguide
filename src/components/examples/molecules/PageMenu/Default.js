...
const menuLinks = [
  {
    heading: 'Privat',
    contentAboveItems:
      '<div><p class="paragraph">Sjekk forbruket og abonnementet ditt, fakturaer og innstillinger.</p><button class="button button--primary">Logg inn</button></div>',
    loggedInLinks: [],
    loggedOutLinks: [
  ...
  },
  {
    heading: 'Bedrift',
    contentAboveItems:
      '<div><p class="paragraph">Administrer dine abonnement og tjenester og få oversikt over fakturaer og rapporter.</p><button class="button button--primary">Logg inn</button></div>',
    loggedInLinks: [],
    loggedOutLinks: [
      { text: 'Bedrift 1', url: '/' },
      { text: 'Bedrift 2', url: '/' },

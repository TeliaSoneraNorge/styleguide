...
const SmallImageInline = () => (
    <div>
        <Image src="/public/website-images/BusinessDevelopment_Pebble.png" alt="Woman looking at tablet" inline="left" />
        <p>
        ...
        <Image src="/public/website-images/BusinessDevelopment_Pebble.png" alt="Woman looking at mobile" inline="right" />
        <p>

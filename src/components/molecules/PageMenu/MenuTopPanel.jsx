...
const MenuTopPanel = ({ isExpanded, onClose, menuId }) => (
    <div className="page-menu__top-panel">
        <button
            ...
            <img className="page-menu__icon-box-icon" src="/public/icons/ico_delete.svg" alt="Vis/skjul meny" />
        ...
        <button
            ...
            onClick={onClose}>
            <img className="page-menu__icon-box-icon" src="/public/icons/ico_search.svg" alt="Vis/skjul meny" />

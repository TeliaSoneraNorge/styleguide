...
const TextBoxWithLabel = ({ labelText, type, placeholder, errorMessage, disabled, loader, loading }) =>
    <Label className={classnames('textbox-with-label', { 'textbox-with-label--with-error': errorMessage, 'textbox-with-label__with-loader': loader, 'textbox-with-label__with-loader--loading': loading })} isUsingGrayText={true}>

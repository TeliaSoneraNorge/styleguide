...
const CartItemPrice = ({ cartItem, hasPaid, onChangeQuantity }: CartItemPriceProps) => {
  ...
  const isManualDiscount = cartItem.discount?.isManualDiscount;
  const discountValueUpfront = isManualDiscount ? 0 : _.get(cartItem.discount, 'value.upfront') || 0;
      ...
      <div className="telia-shopping-cart__item__price__container">
        ...
        <div style={{ position: 'relative' }}>
          ...
          <span className="telia-shopping-cart__item__price__cost">
            ...
            {discountPrice && formatPrice(discountPrice) !== price && (
              <>
                <span className="telia-shopping-cart__item__price__linethroughDisclaimer">ord. pris:</span>

...
const SeveralThemeBoxesWithImage = () => (
    <ThemeBoxesWithImage>
        <ThemeBoxWithImage id="themebox-1"
                           isExpanded={false}
                           imageSrc="/public/website-images/themeBoxWithImage.jpg"
                           heading="Closed themebox with image"></ThemeBoxWithImage>
        <ThemeBoxWithImage id="themebox-2"
                           isExpanded={false}
                           imageSrc="/public/website-images/themeBoxWithImage.jpg"
                           heading="Closed themebox with image"></ThemeBoxWithImage>
        <ThemeBoxWithImage id="themebox-3"
                           isExpanded={true}
                           imageSrc="/public/website-images/themeBoxWithImage.jpg"
...
export default SeveralThemeBoxesWithImage;
...
import { RadioButtonList, RadioButtonWithLabel, Heading, Paragraph, Image } from '@telia/styleguide';
...
const RichContentRadioButtonList = () => (
    <RadioButtonList
        ...
        <RadioButtonWithLabel checked hasRichContent value="0" name="radiobutton-test-3">
            ...
            <img style={{display: 'inline-block', float: 'right', width: '20%'}} src="/public/website-images/zens-charger.png"/>

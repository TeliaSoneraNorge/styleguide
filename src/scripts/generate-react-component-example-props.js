...
const atoms = readComponentsFromDirectory('./component-lib/src/atoms');
const molecules = readComponentsFromDirectory('./component-lib/src/molecules');
const organisms = readComponentsFromDirectory('./component-lib/src/organisms');
const allExampleProps = Object.assign({}, atoms, molecules, organisms);

fs.writeFileSync('./src/component-metadata--react-examples.json', JSON.stringify(allExampleProps, null, 2));
